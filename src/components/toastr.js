...
export function mensagemErro(mensagem){
    mostrarMensagem('Erro', "CPF/CNPJ  ou senha inválido", 'error')
}


export function mensagemErroCpf(mensagem){
    mostrarMensagem('Validar Dados', "CPF/CNPJ já cadastrado", 'errorcpf')
}
